...
var cloudsGroup, cloudImage, bg, winImg, winS;
...
function setup() {
  ...
  winS = createSprite(displayWidth/2,displayHeight - 200);
  winS.addImage("win", winImg);
...
function draw() {
  ...
  textSize(30);
  fill("red");
  text("Score: "+ score, displayWidth/2 - 70, displayHeight/2 );
  console.log(displayHeight);
  if (gameState===PLAY){
    score = score + Math.round(getFrameRate()/60);
    ground.velocityX = -(10 + 3*score/100);
    fill("blue")
    text("Reach 1000 to win", displayWidth/2 - 130, displayHeight/2 + 100 );
